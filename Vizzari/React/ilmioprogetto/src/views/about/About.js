    ...
    <>
      ...
      <div className='container'>
        <div className='row plot'>
          <div className='col '><p>Yu-Gi-Oh! (遊☆戯☆王ＹＵ－ＧＩ－ＯＨ！ Yūgiō, Japanese for "Game King" or "King of Games") is a popular Japanese anime and manga franchise from Kazuki Takahashi that mainly involves characters who play a card game called Duel Monsters (originally called Magic and Wizards in the manga).</p>
          </div>
        </div>
        <div className='row'>
